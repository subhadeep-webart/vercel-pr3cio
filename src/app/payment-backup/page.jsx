...
const Payment = () => {
    ...
    return (
        <div className='flex min-h-screen items-center justify-center bg-gradient-to-r from-gray-800 via-gray-900 to-black p-4'>
            <div className='w-full max-w-md space-y-6 rounded-xl bg-gradient-to-r from-purple-700 via-indigo-700 to-blue-600 p-10 text-center shadow-2xl shadow-lg'>
                {status === 'loading' && (
...
export default withAuthProtection(Payment);
