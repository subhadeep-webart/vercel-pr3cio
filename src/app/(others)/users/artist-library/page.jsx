            ...
            <div className="flex items-start flex-wrap w-full justify-end">
                <div className="bg-[#2B2B2B] rounded-[0.75rem] p-6 sm:w-[calc(100%-1rem)] float-right">
                    ...
                    <div
                        ...
                        <div
                            className=" group mb-3 md:mb-0 hover:bg-[#484848] transition-colors duration-300 p-3 rounded-[0.75rem]">
                            <center>
                                <div
                                    className="max-w-[9.38rem] max-h-[9.38rem] rounded-full p-3 border-1 border-[#585858] mb-2 group-hover:border-[#D344C9] transition-colors duration-300 relative">
                                    <img src="/images/artist/5.webp" alt="skipBack" loading="lazy"
                                        className="rounded-full max-w-[9.38rem] max-h-[9.38rem] rounded-full w-full" />

                                    <span
                                        className=" w-[2.25rem] h-[2.25rem] rounded-full bg-[#C6FF00] flex justify-center items-center text-center transition-colors duration-300 cursor-pointer absolute right-0 bottom-[1rem] opacity-0 group-hover:opacity-100">
                                        <svg width="20" height="18" viewBox="0 0 20 18" fill="none"
                                            className="stroke-current text-black" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <h3 className="text-sm font-semibold">Maecenas biben</h3>
                                <small className="text-xs text-[#9D9D9D]">Artist</small>
                            </center>
                        </div>
                        <div
                            className=" group mb-3 md:mb-0 hover:bg-[#484848] transition-colors duration-300 p-3 rounded-[0.75rem]">
