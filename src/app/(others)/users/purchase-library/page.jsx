        ...
        <div class="flex items-start flex-wrap w-full justify-end">
            <div class="bg-[#2B2B2B] rounded-[0.75rem] p-6 sm:w-[calc(100%-1rem)] float-right">
                <div class="flex justify-between">
                    <h1 class="text-[1.56rem] font-semibold mb-5">My Purchase</h1>
                    <ul class="flex">
                        <li><a href="#"
                                class="bg-[#373437] ml-2 hover:bg-gradient-to-r hover:from-[#D344C9] hover:to-[#2D2694] rounded-[0.50rem] font-medium text-xs text-white px-6 py-2 transition-colors duration-300">Songs</a>
                        </li>
                        <li><a href="#"
                                class="bg-[#373437] ml-2 hover:bg-gradient-to-r hover:from-[#D344C9] hover:to-[#2D2694] rounded-[0.50rem] font-medium text-xs text-white px-5 py-2 transition-colors duration-300">Albums</a>
                        </li>
                    </ul>
                </div>
                <div
