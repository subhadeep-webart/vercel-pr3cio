...
const TrendingAlbum = () => {
    const {
        ...
        queryKey: [queryConstants.getAlbums, true],
        queryFn: ({ pageParam = 1 }) =>
    ...
    return (
        <>
            ...
            <div
                className="grid  grid-cols-2 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 2xl:grid-cols-5 gap-4 overflow-y-auto overflow-x-hidden h-[40rem] [scrollbar-width:none]">
                {status === 'pending' &&
