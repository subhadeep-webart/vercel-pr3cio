            ...
            <div class="bg-[#333232] w-full rounded-[0.75rem]">
                ...
                <div class="planBox ">
                    <div
                     ...
                     {/* <h2 class="font-semibold text-[1.56rem]"> <a href="user-profile.html"
                                class="inline-block w-[2.38rem] h-[2.25rem] rounded-[0.75rem] border-1 border-[#848484] border-solid mr-2 leading-[2.25rem] text-center text-[1rem]"><i
                                    class="bi bi-chevron-left"></i></a> Edit
                            Profile
                            Information
                        </h2>  */}
                            ...
                            <div class="grid grid-cols-12 gap-4 md:gap-x-10 auto-cols-auto">
                                ...
                                <div class="col-span-6 mt-6">
                                    ...
                                    <a href="/profile/change-password"
                                        class="text-[#C6FF00] text-sm float-right mt-1">Change Password</a>
                                </div>
                                <div class="col-span-6 mt-6 text-right">
                                    <button
                                        class="text-sm text-black h-[2.5rem] leading-[2.5rem] px-5 bg-[#C6FF00] rounded-full inline-block max-w-[8.06rem] w-full text-center transition-all duration-300 mt-6 cursor-pointer">Save</button>
                                </div>
                            </div>
                        </form>
                    </div>
