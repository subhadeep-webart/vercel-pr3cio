<Container>
    ...
    <div className='space-y-6'>
        ...
        <form
            className='mx-auto grid grid-cols-1 gap-6 md:grid-cols-2 lg:w-2/3'
            ...
            <div className="grid grid-cols-12 gap-4 items-end mb-6">
                ...
                <div className="col-span-4 text-center cursor-pointer pl-5">
                    ...
                    {/* <button
                        className="inline-flex gap-2 justify-center items-center rounded-full border-1 border-[#666] border-solid px-4 py-3 w-auto">
                        <span
                            className="bg-[#C6FF00] xl:w-[1rem] xl:h-[1rem] xxl:w-[1.46rem] xxl:h-[1.46rem] rounded-full col-span-auto"></span>
                        <span className="xl:text-[0.9rem] xxl:text-[1.05rem] font-medium col-span-auto">Upload
                            mode</span>
                        <span
                            className="xl:text-[0.9rem] xxl:text-[1.05rem] font-medium col-span-auto text-[#4D41FA]">single</span>
                    </button> */}
                </div>
            </div>
            ...
            {/* <Input
                        ...
                        startContent={
                            <span className='font-semibold text-[14px] leading-[20px]'>$</span>
                        }
                    /> */}
            <Textarea
                type='text'
            ...
            <Button
                ...
                {isSubmitting ? 'Publishing...' : 'Publish Song'}
            </Button>
        </form>
    </div>
</Container>