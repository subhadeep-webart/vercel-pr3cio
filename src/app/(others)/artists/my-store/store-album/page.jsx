          ...
          <div class="flex items-start flex-wrap w-full justify-end">
            ...
            <div class="sm:w-[calc(100%-1rem)] mb-6 mt-2">
                <ul class="inline-flex bg-[#2B2B2B] rounded-[0.75rem] py-2 w-auto  pr-2">
                    ...
                    <li><a href="/artists/my-store/store-songs"
                            class="bg-[#373437] ml-2 hover:bg-gradient-to-r hover:from-[#D344C9] hover:to-[#2D2694] rounded-[0.50rem] font-medium text-xs text-white px-4 py-1 transition-colors duration-300 ">Songs</a>
                    </li>
                    <li><a href="/artists/my-store/store-album"
                            class="ml-2 bg-gradient-to-r from-[#D344C9] to-[#2D2694] rounded-[0.50rem] font-medium text-xs text-white px-4 py-1 transition-colors duration-300">Albums</a>
                    </li>
                </ul>
            </div>

            <div class="bg-[#2B2B2B] rounded-[0.75rem] p-6 mr-2 sm:w-[calc(100%-1rem)] float-right">
                <div class="flex justify-between">
                    <h1 class="text-[1.56rem] font-semibold mb-5">Albums</h1>
                    <ul class="flex">
                        <li><a href="#"
