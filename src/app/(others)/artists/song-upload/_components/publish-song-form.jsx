                ...
                <form action="" className="col-span-12 md:col-span-10 md:col-start-2" onSubmit={handleSubmit}
                    ...
                    <div className="grid grid-cols-12 gap-4 items-end mb-6">
                        {values.url ? (
                            ...
                            <button
                                type='button'
                                className="rounded-[0.3rem] border-1 border-[#666] border-solid p-3 col-span-4 z-1 relative after:content-[''] after:absolute after:w-full after:h-full after:bottom-0 after:left-0 bg-custom-gradient after:rounded-[0.3rem] after:z-[-1] text-center cursor-pointer" onClick={handleOpenMusicUpload}>
...
<div className="grid grid-cols-12 gap-4 mt-5 items-end">
                     {touched.url && errors.url && (
                                <p className="text-red-500 text-xs mt-1 col-span-4 md:col-span-4">{errors.url}</p>
                            )}

                      {touched.artwork && errors.artwork && (
                                <p className="text-red-500 text-xs mt-1 col-span-4 md:col-span-4">{errors.artwork}</p>
                            )}
                            </div>
                    ...
                    <div className="grid grid-cols-12 gap-4 mt-5 items-end">
                        <div className='col-span-6 mt-6'>
                            ...
                            <input
                                id="amount"
                                type="text"
                                className={`w-full rounded-md px-3 h-[3rem] text-sm border-1 bg-[#2E2E2E] ${touched.amount && errors.amount
                                    ? 'border-red-500'
                                    : 'border-[rgba(255,255,255,0.15)]'
                                    }`}
    ...
    onSelectionChange={(keys) => {
      setFieldValue('tags', Array.from(keys));
                ...
                bg-[#2E2E2E] text-[#929292]`,
                    ...
                    <div className="grid grid-cols-12 gap-4 mt-5 items-end">
                        <div className="mb-2 relative col-span-12 md:col-span-6 mt-6">
                            <Select
                                className="w-full"
                                label="Credit Name"
                ...
                bg-[#2E2E2E] text-[#929292]`,
                        ...
                        <div className="mb-2 relative col-span-12 md:col-span-5 mt-6">
                            <Select
                                className="w-full"
                                label="Credit Role"
