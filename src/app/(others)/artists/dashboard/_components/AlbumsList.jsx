...
const AlbumsList = () => {
    ...
    const { data, isFetching, status } = useQuery({
        queryKey: [queryConstants.artistDashboardItemList, { type: 'album' }],
        queryFn: () =>
            getArtistDashboardItemList({ page: 1, limit: 3, type: 'album' }),
    ...
    console.log('albums list', albums)
    ...
    return (
        <>
            <div className='rounded-2xl bg-[#2A2929] p-4'>
                <h3 className='mb-4 text-[0.938rem] font-medium'>Albums</h3>
