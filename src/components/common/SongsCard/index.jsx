...
import ArtistDetailsSkeleton from '@/app/(others)/artists/_components/artist-details-skeleton'
...
const SongsCard = ({
    ...
    const slug = '683d36cf0284004f0e94c391' || params.get('id')
    const dispatch = useDispatch()
      const artist = useSelector((state) => state?.artist?.data)
    console.log('songs', artist?.data)
                        ...
                        <ul className='mx-3 flex min-w-[8rem] items-center'>
                            {showDownload && (
                                <li className='ml-3'>
                                    <a
                                        href='#'
                                        className='group flex h-[2.00rem] w-[2.00rem] items-center justify-center rounded-full bg-[#191919]'>
                                        <svg
                                            width='15'
                                            height='15'
                                            viewBox='0 0 9 12'
                            ...
                            {showShare && (
                                <li className='ml-3'>
                                    <a
                                        href='#'
                                        className='group flex h-[2.00rem] w-[2.00rem] items-center justify-center rounded-full bg-white transition-colors duration-300 hover:bg-[#4D41FA]'>
                                        <svg
                                            width='12'
                                            height='12'
                                            viewBox='0 0 10 10'
                            ...
                            {showBuy && (
                                <li className='ml-6'>
                                    <a
                                        href='#'
                                        className='grou flex h-[2.63rem] w-[2.63rem] items-center justify-center rounded-full bg-[#C6FF00] transition-colors duration-300'>
                                        <svg
                                            width='18'
                                            height='19'
                                            viewBox='0 0 18 19'
                                            fill='none'
                                            xmlns='http://www.w3.org/2000/svg'
                                            className='fill-current stroke-current text-black transition-colors duration-300 group-hover:text-white'>
