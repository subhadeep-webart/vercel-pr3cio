            ...
            <div className='mt-5 w-full pl-3 pr-3 sm:w-[calc(100%-11.63rem)]'>
                <div className='flex flex-wrap items-center justify-between rounded-[0.63rem] bg-[linear-gradient(to_right,rgba(77,65,250,1)_0%,rgba(255,38,99,1)_100%)] p-8 md:flex-nowrap'>
                    ...
                    <span className='inline-block text-center'>
                        <a
                            href='#'
                            className='rounded-4xl inline-block h-[1.50rem] md:h-[2.50rem] bg-white px-4 text-xs font-semibold leading-[1.50rem] md:leading-[2.50rem] text-black transition-colors hover:bg-[rgba(249,255,69,0.82)] hover:text-black lg:px-9'>
                            Sign up now
                        </a>
                    </span>
                </div>
